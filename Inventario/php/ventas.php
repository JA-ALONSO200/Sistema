...
<div class="container">
    ...
    <div class="row-12">
        <form action="ventas.php" method="post" class="buttons">
        <button type="submit" class="btn btn-success" name="agregar_cliente">Registrar Cliente</button>
        <button type="submit" class="btn btn-warning" name="agregar_venta">Añadir Venta</button>
        </form>
        </div>
    ...
    <form action='eliminar.php' method='post' class="form">
        <input type='hidden' name='id_ventas' value='<?php echo htmlspecialchars($ventas['id_ventas']); ?>'>
        <input type='submit' name="eliminar_v" class="btn btn-danger" value="Eliminar">
    </form>
</center></td>
</tr>
            <?php endforeach; ?>
